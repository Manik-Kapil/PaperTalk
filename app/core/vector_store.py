...
# Function to make connection with Qdrant Cloud Cluster
@lru_cache
    ...
    def get_collection_info(self) -> dict:
        ...
        try:
            ...
            return {
                ...
                "points_count": info.points_count, # How many documents are available within that particular collection
