...
# Life of an API call - Defines the lifespan of the API CALL
...
# Mount static files
# Commented for now as the UI Still needs to be created
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        ...
        reload=True, # In production reload should be false
    )